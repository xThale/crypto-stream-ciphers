...
To measure the qualities of a cipher concerning correlation attacks, a new term is introduced. A function is $m^{th}$-order correlation-immune when any subset of $m$ input bits are uncorrelated to the output bit \cite[p. 777]{Siegenthaler.1984}. Interestingly, a high linear complexity $L$ of the combination function results in low correlation-immunity $m$ \cite[p. 779]{Siegenthaler.1984}. 
